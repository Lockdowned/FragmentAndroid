...
class ListFragment() : Fragment(R.layout.fragment_list) {
    ...
    lateinit var adaptorItemSelectListener: (VehicleItem) -> Unit
...
//        vehicleListAdapter = VehicleListAdapter(mutableListOf()) // not actual after private val vehicleListViewModel: VehicleListViewModel by activityViewModels()
        if (vehicleListAdapter == null){
            var vehicleList = vehicleListViewModel.vehicleList
            vehicleListAdapter = VehicleListAdapter(vehicleList, locContext as MainActivity)
